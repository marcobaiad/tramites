    ...
    return (
        <MainDiv page={
            <>
                ...
                En necesario realizar este permiso cuando una persona va a conducir regularmente (o no) un vehículo que no es própio y la cédula verde esté vendica, ya que, en caso de estar vigente, no es necesario circular con la tarjeta Azul. <br />
                ...
                <div className="alert alert-info border-info" role="alert">
                    <strong>¿La Cédula Azul tiene vencimiento? </strong> La respuesta es no, la cédula azul no tiene vencimiento.
                </div>
                {/* <ol className="my-3">
                    <li>
