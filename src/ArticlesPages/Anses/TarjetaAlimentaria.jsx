    ...
    return(
        ...
        <>
           ...
           <h1 className="my-3 pt-3 text-center">Tarjeta Alimentaria</h1>
            ...
            <h2>¿Como tramitar la tarjeta Alimentaria?</h2>
            ...
            <h2>¿A quien le corresponde la tarjeta Alimentaria?</h2>
            ...
            <h2>Monto de la Tarjeta Alimentar</h2>
            ...
            <h3>¿Qué hacer en caso de Robo o extravío de la tarjeta Alimentaria?</h3> Si perdes tu tarjeta, o te robaron la misma, el titular debe gestionar una nueva con el banco emisor. Previo a realizar el trámite, deberás solicitar un turno en la entidad bancaria.
            <ul>
                ...
                <li><a href="https://www.nbch.com.ar/Personas/Banca-Electronica/Turnos-web" data="_blank" rel="noopener noreferrer" title="click para abrir página web de turnos Nuevo Banco del Chaco">Nuevo Bando del Chaco </a><a href="tel:08009996224"> 0800-999-6224 o</a><a href="tel:08002226224"> 0800-222-6224</a></li>
            </ul>            
