...
export default function SeguroDesempleo() {
    return (
        ...
        <>
            ...
            El <strong>monto a percibir</strong> por el <strong>seguro de desempleo de ANSES</strong> y el periodo durante el cual te verás beneficiado, va a depender de tu edad y un calculo sobre tus últimos 3 años trabajados. La duración de este beneficio es de entre 2 a 12 meses y en caso de tratarse de personas mayores de 45 años, el beneficio se extiende hasta los 18 meses.
            <h2>Requisitos para cobrar Fondo de Desempleo</h2>
            ...
            <h2>Trámite para cobrar Fondo de Desempleo</h2>
